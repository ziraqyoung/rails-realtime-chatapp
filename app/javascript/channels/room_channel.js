        ...
        var content = `<div class="flex items-center m-2">
            ...
            <div class="ml-1 w-full p-2 rounded-lg bg-teal-200 text-gray-900">
              <div class="text-sm text-right">
                <small class="leading-tight text-gray-600 uppercase" data-role="message-date">${data.username}</small>
              </div>
            <div data-role="message-text" class="text-base">${data.message}</div>
              <div class="text-sm text-right">
                <small class="leading-tight text-gray-600" data-role="message-date">${data.updated_at}</small>
              </div>
            </div>
          </div>`;
